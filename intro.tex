...
of the saturated model.  Because the linear transformations are continuous
functions and the preimage of an open set through a continuous function is open,
